...
guardar.onclick=()=>{
    ...
    if(nombre.trim()==="" || ap.trim()==="" || am.trim()===""){
        Swal.fire({
            title: "Alumnos",
            text:"Tienes campos vacíos, por favor ingresa valores válidos",
            icon:"error"
        });
        return;
    }
...
alumnos.forEach(a=>{
    ...
    <td><button class="btn btn-info" onclick="mostrarAlumnos(${index})" data-bs-toggle="modal" data-bs-target="#actualizarR"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
    ...
    Swal.fire({
       ...
       denyButtonText:"No estoy seguro"
        ...
        if(result.isConfirmed){
            ...
            localStorage.setItem("alumnos", JSON.stringify(alumnos));
            imprimirAlumnos();
            Swal.fire("El alumno ha sido eliminado éxitosamente","", "success");
        }
    });
